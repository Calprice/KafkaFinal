...
public class BasicConsumerExample {
    public static void main(String[] args) {
        ...
        //Is that the correct directory for the truststore
        props.put(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, "SSL");
        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, "src/main/resources/kafka.client.truststore.jks");
        props.put(SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG, "cisco123");

        //configure the following three settings for SSL Authentication
        //Is that the correct directory for the keystore?
        props.put(SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG, "src/main/resources/kafka.client.keystore.jks");
